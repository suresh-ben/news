...
export default function TextContentConfigOptions({
  ...
  const [text, setText] = useState(selectedBoxOptions.content?.text || "");
  useEffect(() => { setText(selectedBoxOptions.content?.text || "") }, [selectedBoxIndexes, selectedBoxOptions.content?.text])
  useEffect(() => { updateContentType("text", text) }, [text])
