...
import FloatingOptions from "./editor/FloatingOptions";
...
export default function Editor({
  ...
  return (
    <div className="w-[50%] h-full bg-gray-600 text-white flex flex-col justify-between">
      <div>
        <PageOptions setPageSize={setPageSize} addPage={addPage} />
        {selectedBoxIndexes && selectedBoxIndexes.length > 0 && (
          <div className="p-4">
            ...
            />
            {
              selectedBoxOptions?.isFloating && <FloatingOptions 
                setPageContent={setPageContent}
                selectedBoxIndexes={selectedBoxIndexes}
                selectedBoxOptions={selectedBoxOptions}
              />
      ...
      <PDFDownloadLink document={<PDF pageContent={pageContent} assets={assets} pdfContent={pdfContent} />} fileName="paper.pdf">
